...
func TestFindIntersectionsBetweenPolys(t *testing.T) {
	tests := map[string]struct {
		...
		"No intersections": {
			poly1: []polyPoint[int]{
				{point: NewPoint(0, 0), pointType: pointTypeOriginal},
				{point: NewPoint(4, 0), pointType: pointTypeOriginal},
				{point: NewPoint(2, 2), pointType: pointTypeOriginal},
			},
			poly2: []polyPoint[int]{
				{point: NewPoint(6, 6), pointType: pointTypeOriginal},
				{point: NewPoint(8, 6), pointType: pointTypeOriginal},
				{point: NewPoint(7, 8), pointType: pointTypeOriginal},
			},
			expectedPoly1Out: []polyPoint[int]{
				{point: NewPoint(0, 0), pointType: pointTypeOriginal},
				{point: NewPoint(4, 0), pointType: pointTypeOriginal},
		...
		"Multiple intersections": {
			poly1: []polyPoint[int]{
				{point: NewPoint(0, 0), pointType: pointTypeOriginal},
				{point: NewPoint(4, 0), pointType: pointTypeOriginal},
				{point: NewPoint(4, 4), pointType: pointTypeOriginal},
				{point: NewPoint(0, 4), pointType: pointTypeOriginal},
			},
			poly2: []polyPoint[int]{
				{point: NewPoint(2, 2), pointType: pointTypeOriginal},
				{point: NewPoint(6, 2), pointType: pointTypeOriginal},
				{point: NewPoint(6, 6), pointType: pointTypeOriginal},
				{point: NewPoint(2, 6), pointType: pointTypeOriginal},
			},
			expectedPoly1Out: []polyPoint[int]{
				{point: NewPoint(0, 0), pointType: pointTypeOriginal},
				{point: NewPoint(4, 0), pointType: pointTypeOriginal},
	...
	tests := map[string]struct {
		...
		"Simple intersection for union": {
			...
			expectedPoly1: []polyPoint[int]{
				{point: NewPoint(0, 0), pointType: pointTypeOriginal},
				{point: NewPoint(4, 0), pointType: pointTypeOriginal},
				{point: NewPoint(4, 2), pointType: pointTypeAddedIntersection, entryExit: intersectionTypeExit, otherPolyPointIndex: 2},
				{point: NewPoint(4, 4), pointType: pointTypeOriginal},
				{point: NewPoint(2, 4), pointType: pointTypeAddedIntersection, entryExit: intersectionTypeEntry, otherPolyPointIndex: 0},
				{point: NewPoint(0, 4), pointType: pointTypeOriginal},
			},
			expectedPoly2: []polyPoint[int]{
				{point: NewPoint(2, 4), pointType: pointTypeAddedIntersection, entryExit: intersectionTypeExit, otherPolyPointIndex: 4},
				{point: NewPoint(2, 2), pointType: pointTypeOriginal},
				{point: NewPoint(4, 2), pointType: pointTypeAddedIntersection, entryExit: intersectionTypeEntry, otherPolyPointIndex: 2},
				{point: NewPoint(6, 2), pointType: pointTypeOriginal},
				{point: NewPoint(6, 6), pointType: pointTypeOriginal},
				{point: NewPoint(2, 6), pointType: pointTypeOriginal},
			},
		...
		"Simple intersection for intersection": {
			...
			expectedPoly1: []polyPoint[int]{
				...
				{point: NewPoint(4, 2), pointType: pointTypeAddedIntersection, entryExit: intersectionTypeEntry, otherPolyPointIndex: 2},
				{point: NewPoint(4, 4), pointType: pointTypeOriginal},
				{point: NewPoint(2, 4), pointType: pointTypeAddedIntersection, entryExit: intersectionTypeExit, otherPolyPointIndex: 0},
				{point: NewPoint(0, 4), pointType: pointTypeOriginal},
			},
			expectedPoly2: []polyPoint[int]{
				{point: NewPoint(2, 4), pointType: pointTypeAddedIntersection, entryExit: intersectionTypeEntry, otherPolyPointIndex: 4},
				{point: NewPoint(2, 2), pointType: pointTypeOriginal},
				{point: NewPoint(4, 2), pointType: pointTypeAddedIntersection, entryExit: intersectionTypeExit, otherPolyPointIndex: 2},
				{point: NewPoint(6, 2), pointType: pointTypeOriginal},
				{point: NewPoint(6, 6), pointType: pointTypeOriginal},
...
func TestPolygon_Points(t *testing.T) {
	tests := map[string]struct {
		...
		"Normal points only": {
			...
			pointTypes: []polyPointType{
				pointTypeOriginal, pointTypeOriginal, pointTypeOriginal, pointTypeOriginal,
			},
			expectedPoints: []Point[int]{
				NewPoint(0, 0),
				NewPoint(5, 0),
		...
		"Mixed point types": {
			...
			pointTypes: []polyPointType{
				pointTypeOriginal, pointTypeOriginal, pointTypeAddedIntersection, pointTypeOriginalAndIntersection, pointTypeOriginal,
			},
			expectedPoints: []Point[int]{
				NewPoint(0, 0),
				NewPoint(5, 0),
...
func TestTraverse_Intersection(t *testing.T) {
	tests := map[string]struct {
		...
		"Simple intersection": {
			...
			expectedResults: [][]polyPoint[int]{
				{
					{point: NewPoint(4, 2), pointType: pointTypeAddedIntersection, entryExit: intersectionTypeEntry, visited: false, otherPolyPointIndex: 2},
					{point: NewPoint(4, 4), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyPointIndex: 0},
					{point: NewPoint(2, 4), pointType: pointTypeAddedIntersection, entryExit: intersectionTypeEntry, visited: false, otherPolyPointIndex: 4},
					{point: NewPoint(2, 2), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyPointIndex: 0},
				},
			},
		},
		"No intersection": {
		...
		"Nested polygons (poly2 inside poly1)": {
			...
			expectedResults: [][]polyPoint[int]{
				{
					{point: NewPoint(2, 2), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyPointIndex: 0},
					{point: NewPoint(4, 2), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyPointIndex: 0},
					{point: NewPoint(4, 4), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyPointIndex: 0},
					{point: NewPoint(2, 4), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyPointIndex: 0},
				},
			},
		},
	}
...
func TestTraverse_Union(t *testing.T) {
	tests := map[string]struct {
		...
		"Multiple intersections": {
			...
			expectedResults: [][]polyPoint[int]{
				{
					{point: NewPoint(2, 4), pointType: pointTypeAddedIntersection, entryExit: intersectionTypeEntry, visited: false, otherPolyPointIndex: 0},
					{point: NewPoint(0, 4), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyPointIndex: 0},
					{point: NewPoint(0, 0), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyPointIndex: 0},
					{point: NewPoint(4, 0), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyPointIndex: 0},
					{point: NewPoint(4, 2), pointType: pointTypeAddedIntersection, entryExit: intersectionTypeEntry, visited: false, otherPolyPointIndex: 2},
					{point: NewPoint(6, 2), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyPointIndex: 0},
					{point: NewPoint(6, 6), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyPointIndex: 0},
					{point: NewPoint(2, 6), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyPointIndex: 0},
				},
			},
		},
		"Non-intersecting polygons": {
			...
			expectedResults: [][]polyPoint[int]{
				...
				{
					{point: NewPoint(6, 6), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyPointIndex: 0},
					{point: NewPoint(10, 6), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyPointIndex: 0},
					{point: NewPoint(10, 10), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyPointIndex: 0},
					{point: NewPoint(6, 10), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyPointIndex: 0},
				},
			},
		},
	}
