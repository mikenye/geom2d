	...
	tests := map[string]struct {
			...
			expectedResults: [][]polyPoint[int]{
				{
					...
					{point: NewPoint(4, 4), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyIndex: 0},
					{point: NewPoint(2, 4), pointType: pointTypeAddedIntersection, entryExit: intersectionTypeEntry, visited: false, otherPolyIndex: 4},
					{point: NewPoint(2, 2), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyIndex: 0},
				},
			},
		},
		"No intersection": {
		...
		"Nested polygons (poly2 inside poly1)": {
			...
			expectedResults: [][]polyPoint[int]{
				{
					{point: NewPoint(2, 2), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyIndex: 0},
					{point: NewPoint(4, 2), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyIndex: 0},
					{point: NewPoint(4, 4), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyIndex: 0},
					{point: NewPoint(2, 4), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyIndex: 0},
				},
			},
		},
	}
	...
	tests := map[string]struct {
			...
			expectedResults: [][]polyPoint[int]{
				{
					...
					{point: NewPoint(0, 4), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyIndex: 0},
					{point: NewPoint(0, 0), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyIndex: 0},
					{point: NewPoint(4, 0), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyIndex: 0},
					{point: NewPoint(4, 2), pointType: pointTypeAddedIntersection, entryExit: intersectionTypeEntry, visited: false, otherPolyIndex: 2},
					{point: NewPoint(6, 2), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyIndex: 0},
					{point: NewPoint(6, 6), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyIndex: 0},
					{point: NewPoint(2, 6), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyIndex: 0},
				},
			},
		},
		"Non-intersecting polygons": {
			...
			expectedResults: [][]polyPoint[int]{
				...
				{
					{point: NewPoint(6, 6), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyIndex: 0},
					{point: NewPoint(10, 6), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyIndex: 0},
					{point: NewPoint(10, 10), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyIndex: 0},
					{point: NewPoint(6, 10), pointType: pointTypeOriginal, entryExit: intersectionTypeNotSet, visited: false, otherPolyIndex: 0},
				},
			},
		},
	}
