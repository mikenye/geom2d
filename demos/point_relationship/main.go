...
type App struct {
	...
	mousePoint     geom2d.Point[int] // Current mouse position as a geom2d Point.
...
func (app *App) Update() error {
	...
	app.mousePoint = geom2d.NewPoint[int](app.mouseX, app.mouseY)

	// Update relationships for each geometric object.
	app.pointRelationship = app.mousePoint.RelationshipToPoint(app.point, geom2d.WithEpsilon(1e-9))
	app.lineSegmentRelationship = app.mousePoint.RelationshipToLineSegment(app.lineSegment, geom2d.WithEpsilon(1e-9))
	app.rectangleRelationship = app.mousePoint.RelationshipToRectangle(app.rectangle, geom2d.WithEpsilon(1e-9))
	app.circleRelationship = app.mousePoint.RelationshipToCircle(app.circle, geom2d.WithEpsilon(1))
	app.polyTreeRelationship = app.mousePoint.RelationshipToPolyTree(app.polyTree, geom2d.WithEpsilon(1))
...
func (app *App) initGeometry() error {
	...
	app.mousePoint = geom2d.NewPoint[int](0, 0)
...
func main() {
	...
	ebiten.SetWindowTitle("geom2d demo: point relationship to...")
